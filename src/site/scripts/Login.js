            ...
            <h2>Register</h2>
                <form method="POST" action="" aria-label="Register">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="name" type="text" class="form-control" name="name" required placeholder="Johnny Appleseed" />
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-6">
                            <input id="email" placeholder="example@example.com" type="email" class="form-control" name="email" required />
